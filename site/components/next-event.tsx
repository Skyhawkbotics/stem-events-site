...
export async function NextEvent() {
    ...
    return (
        <div className="bg-gradient-to-br from-primary/5 to-secondary/5 border border-primary/20 rounded-lg p-5 shadow-md hover:shadow-lg transition-all duration-300">
